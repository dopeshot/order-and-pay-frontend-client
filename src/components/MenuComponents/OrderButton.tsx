export const OrderButton: React.FunctionComponent = () => {
    ...
    return (
        ...
        <button className="menuButton bg-red bg-cover text-white h-16 grid grid-cols-5 flex items-center shadow-2xl" style={{ boxShadow: "0px 10px 25px 10px rgba(255, 112, 112, 1)" }}>
